...
void AItem::BeginPlay()
{
	...
	//Set Item states based on default ItemState
...
void AItem::ItemInterp(float DeltaTime)
{
	...
	if (Character && ItemZCurve)
	{
		...
		const FRotator CameraRotation{ Character->GetFirstPersonCamera()->GetComponentRotation() };
...
void AItem::StartItemCurve(AMainCharacter* Char)
{
	...
	const float CameraRotationYaw{ Character->GetFirstPersonCamera()->GetComponentRotation().Yaw };
	// Get initial Yaw of the Item
	const float ItemRotationYaw{ GetActorRotation().Yaw };
	// Initial Yaw offset between Camera and Item
	InterpInitialYawOffset = ItemRotationYaw - CameraRotationYaw;
	//InterpInitialYawOffset = 180.f;
}
